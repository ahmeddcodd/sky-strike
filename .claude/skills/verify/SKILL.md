...
- Driver scripts live in `.claude/skills/verify/` — run from the repo root with a screenshot dir argument. They default to port 5174; set `GAME_PORT` to target another port (e.g. `vite preview`, which auto-increments from 4173):
